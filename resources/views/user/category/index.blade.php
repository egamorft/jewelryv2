...
<div class="box-category">
   <p class="title-category">DI SẢN_TỐT NHẤT</p>
   <img src="{{asset('assets/images/banner-category.jpg')}}" class="w-100">
   <div class="box-header-menu-category">
      <div class="item-menu-category">
         <a href="" class="title-menu-category menu-category-active">Heritage BEST</a>
         <a href="" class="title-menu-category">Rings</a>
         <a href="" class="title-menu-category">Necklace</a>
         <a href="" class="title-menu-category">Earring</a>
         <a href="" class="title-menu-category">Bracelet</a>
         <a href="" class="title-menu-category">only one</a>
         <a href="" class="title-menu-category">View All</a>
      </div>
