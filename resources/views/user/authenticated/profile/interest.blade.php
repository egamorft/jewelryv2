            ...
            <div class=" ec-base-product">
                <ul class="xans-element- xans-myshop xans-myshop-wishlistitem wish-list mt-20 flex flex-wrap gap-10">
                    ...
                    <li class="prd-card wish-item soldout-displaynone-when-has-stock mb-30 xans-record- on-extra-sale">
                        <div class="thumbnail">
                            <a href="#"><img
                                    src="{{asset($item->thumbnail_img)}}"
                                    alt="" class="loaded"></a>
                            <div class="wish-del">
                                <a href="#none" class="btn_wishlist_del" rel="6518||||">
                        ...
                        <div class="description mt-20">
                            ...
                            <div class="btns mt-20">
                                <a href="#" class="btn prior-2 is-small ">Put in a shopping cart</a>
                            </div>
                        </div>
                    </li>
                    @endforeach
                    ...
                    {{-- <li class="prd-card wish-item soldout-displaynone-when-has-stock mb-30 xans-record- on-extra-sale">
                        <div class="thumbnail">
                            <a href="#"><img
                                    src="//www.dona-d.com/web/product/medium/202402/70ca85464490514cdeae31abc278e8c3.jpg"
                                    alt="" class="loaded"></a>
                            <div class="wish-del">
                                <a href="#none" class="btn_wishlist_del" rel="6518||||">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="15.167" height="14"
                        ...
                        <div class="description mt-20">
                            <div>
                                <a href="#">Donna Andy Classic Black Diamond Tennis Bracelet [4mm]</a>
                            </div>
