...
@section('main')
    <main id="main" class="main d-flex flex-column justify-content-center">
        <div class="">
            <!-- Page Heading -->
            <h1 class="h3 mb-4 text-gray-800">Live videos list</h1>
            <hr>

            <div class="d-flex justify-content-start">
                <a href="{{ route('admin.live.video.create') }}" type="button" class="btn btn-outline-primary"><i
                        class="fa-solid fa-rotate"></i>Add more videos</a>
            </div>

            <table class="table" id="tableListVideos">
                <thead>
                    <tr>
