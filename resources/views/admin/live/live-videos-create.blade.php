...
@section('main')
    <main id="main" class="main d-flex flex-column justify-content-center">
        <div class="">
            <!-- Page Heading -->
            <h1 class="h3 mb-4 text-gray-800">Create videos</h1>
            <hr>
            <div class="container">
                <form method="POST" action="{{ route('admin.live.video.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <label for="view" class="form-label">View number</label>
                            <input name="view" id="view" type="number" min="0" class="form-control"
                                placeholder="Enter view number" value="{{ old('view') }}">
                        </div>
                        <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="target_url" id="targetUrl" type="text" class="form-control"
                            placeholder="Enter your video target url" value="{{ old('target_url') }}">
                    </div>
                    <div class="mb-3">
                        <label for="description" class="form-label">Description</label>
                        <textarea name="description" class="form-control" id="description" rows="3" placeholder="Enter video description">{{ old('description') }}</textarea>
                    </div>
                    <div class="mb-3">
