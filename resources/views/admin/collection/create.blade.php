            ...
            <div class="bg-white p-4">
                ...
                <form action="{{route('admin.collection.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row mt-3">
                     ...
                     <div class="col-8">
                        <textarea type="text" class="form-control  text-sm" name="describe" required rows="4" class="ckeditor"></textarea>
                     </div>
                 </div>
                    <div class="row mt-3">
                    ...
                    <div class="row mt-3">
                        <div class="col-3">
                           Location :</div>
                        <div class="col-8">
                            <input class="form-control" name="index" value="0" type="number">
                        </div>
                    </div>
                    <div class="row mt-3">
