                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a class="btn btn-success"
                                   href="{{route('admin.styling.create')}}">Add styling</a>
                            </div>
                            <div class="mb-3 d-flex justify-content-end">
                                <form class="d-flex align-items-center w-50" method="get"
                                      action="{{route('admin.styling.index')}}">
                                    <input name="key_search" type="text" value="{{request()->get('key_search')}}"
                                           placeholder="Search title styling" class="form-control" style="margin-right: 16px">
                                    <button class="btn btn-info"><i class="bi bi-search"></i></button>
                                    <a href="{{route('admin.styling.index')}}" class="btn btn-danger" style="margin-left: 15px">Cancel </a>
                                </form>
                            </div>
                            <table class="table">
